    ...
    <section id="top-recipes" class="py-5">
        <div class="container">
            ...
            <div class="row justify-content-center">
                <?php
                // Fetch the top 3 liked recipes
                $sql = "SELECT * FROM recipes ORDER BY likes DESC LIMIT 3";
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '<div class="col-md-4">
                                <div class="card mb-4" id="r">
                                    <img src="' . $recipeImage . '" class="card-img-top" alt="Recipe Image">
